...
public class MachineGunRound extends Projectile {
	 ...
	 * @return The Bullet
	 */
	public MachineGunRound() {
		this( Assets.MachineGunBullet );
	}
	 ...
	 */
	public MachineGunRound( Texture pTexture ) {
...
//    	markToRemove( true );	// Stage handles actual removal
    	ProjectilePool.recycleMachineGunRound( this );	// takes car of disabling physics and graphics
    }
